...
// está presente, ver 20261005000000_add_charges_schedule_id.sql) — Horarios
// usa esto para precargar el formulario de cobro al hacer clic en
// "Entregado" sobre un horario que ya fue cobrado antes.
...
export const createScheduleCharge = async (
  ...
  // AddPayrollEntryScreen/fetchChargeForSchedule), la sincronizamos con el
